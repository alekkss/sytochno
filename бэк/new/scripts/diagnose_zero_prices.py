...
# Проблемные карточки — цены не собрались при наличии свободных дней
PROBLEM_LISTINGS: list[dict[str, str | int]] = [
    {"id": "1022221", "label": "цен=0"},
    {"id": "356459", "label": "цен=0"},
    {"id": "941251", "label": "цен=0"},
    {"id": "1069751", "label": "цен=0"},
    {"id": "945405", "label": "цен=0"},
    {"id": "1668560", "label": "цен=0"},
    {"id": "1782078", "label": "цен=0"},
    {"id": "600591", "label": "цен=0"},
    {"id": "1096229", "label": "цен=0"},
    {"id": "966087", "label": "цен=0"},
    {"id": "1491671", "label": "цен=0"},
    {"id": "949603", "label": "цен=0"},
    {"id": "144294", "label": "цен=0"},
    {"id": "937515", "label": "цен=0"},
    {"id": "1577161", "label": "цен=0"},
    {"id": "622095", "label": "цен=0"},
    {"id": "4255", "label": "цен=0"},
    {"id": "1462259", "label": "цен=0"},
    {"id": "1500805", "label": "цен=0"},
    {"id": "603829", "label": "цен=0"},
    {"id": "2115821", "label": "цен=0"},
    {"id": "1516995", "label": "цен=0"},
    {"id": "728283", "label": "цен=0"},
    {"id": "1703370", "label": "цен=0"},
    {"id": "1112491", "label": "цен=0"},
    {"id": "1433157", "label": "цен=0"},
    {"id": "1118627", "label": "цен=0"},
    {"id": "828075", "label": "цен=0"},
    {"id": "464929", "label": "цен=0"},
    {"id": "1425437", "label": "цен=0"},
    {"id": "934937", "label": "цен=0"},
]
